...
namespace WebDoAn.Areas.Admin.Controllers
{
    ...
    public class BlogsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("BlogID,Title,Alias,Description,Detail,Image,CreatedDate,CreatedBy,IsActive,Tags,Category")] Blog blog)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("BlogID,Title,Alias,Description,Detail,Image,CreatedDate,CreatedBy,IsActive,Tags,Category")] Blog blog)
        {
            if (id != blog.BlogID)
            {
                return NotFound();
